...
#### Problem: There are no datasets which classifies various emotions of human being
- Datatset: [15 free sentiment analysis datasets](https://gengo.ai/datasets/15-free-sentiment-analysis-datasets-for-machine-learning/?utm_campaign=c&utm_medium=quora&utm_source=rei)
- **Stanford140(1.4million twitter dataset, sentiment type: positive, negative, neutral)**
    - [Analysis of Standford140](https://towardsdatascience.com/search?q=Another%20Twitter%20sentiment%20analysis%20with%20Python%E2%80%8A) 
    ...
    - [iPython](https://github.com/tthustla/twitter_sentiment_analysis_part11/blob/master/Capstone_part11.ipynb)
    - [Stanford 140 paper](https://cs.stanford.edu/people/alecmgo/papers/TwitterDistantSupervision09.pdf) 
- **Naver Movie Review Dataset(Sentiment type: positive, negative)**

### Music Generation Models
- [Music Generation based on novel](http://www.aclweb.org/anthology/W14-0901)
